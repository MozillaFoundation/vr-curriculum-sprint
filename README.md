...
- ***Curate those lesson plans into a Web VR 101 curriculum module*** to be featured on Mozilla’s [teaching activities page](https://learning.mozilla.org).
...
- Sequence Web VR lessons with other coding lessons (i.e. HTML lessons on [Thimble](https://thimble.mozilla.org)) 
...
- [UTeach Outreach: Intro to Web VR Lessons](https://outreach.uteach.utexas.edu/mozilla-gigabit) 
...
- Then visit [our repo](https://github.com/MozillaFoundation/vr-curriculum-sprint).
